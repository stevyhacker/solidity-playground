$(function () {  // equivalent to $(document).ready(...)
    if (typeof(web3) === "undefined") {
        ...
        var hodlContractABI = [{
            ...
            "name": "hodlers",
            "outputs": [{"name": "etherBalance", "type": "uint256"}, {"name": "hodler", "type": "address"}],
            "payable": false,
            ...
            "inputs": [{"name": "token", "type": "address"}, {
                "name": "tokenSymbol",
                "type": "bytes1"
            }, {"name": "amount", "type": "uint256"}, {"name": "timeLimit", "type": "uint256"}],
            "name": "hodlDeposit",
            "outputs": [],
            "payable": false,
            "stateMutability": "nonpayable",
            ...
            "anonymous": false,
            "inputs": [{"indexed": true, "name": "hodler", "type": "address"}, {
                "indexed": false,
                "name": "token",
                "type": "address"
        ...
        tokenContract.balanceOf.call(web3.eth.defaultAccount, function (err, result) {
            ...
            var balanceWhole = result.toString().slice(0, 2);
            var balanceDecimal = result.toString().slice(2, result.toString().length);
            var balance = parseFloat(balanceWhole + "." + balanceDecimal);
    ...
    $.getJSON("web/tokens-eth.json", function (obj) {
        $.each(obj, function (key, value) {
            $("#tokenSelector").append("<option>" + value.name + " (" + value.symbol + ")"  + "</option>");
        });
    });
